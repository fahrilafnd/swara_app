          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                audiens 3D yang responsif. Fitur ini memungkinkan pengguna
                berlatih public speaking secara realistis melalui berbagai
                skenario, seperti Pidato, MC, dan Wawancara.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-400 to-indigo-500 rounded-2xl p-6 relative">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-white font-semibold text-lg">
                  Komponen Penilaian Podium Swara
                </h3>
