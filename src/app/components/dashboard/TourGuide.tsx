      ...
      driverRef.current = driver({
        ...
        steps: [
          // 1. StatsCards sebagai Hasil Latihan
          {
            ...
            popover: {
              title: 'Hasil Latihan',
              description: 'Kamu bisa melihat hasil dari latihannmu dengan statistik di sini.',
              side: 'bottom',
              align: 'start',
            },
          },
          // 2. EventCard sebagai Event & Panduan
          {
            ...
            popover: {
              title: 'Event & Panduan',
              description: 'Ikuti event, webinar, dan lihat panduan belajar public speaking.',
              side: 'bottom',
              align: 'start',
            },
          },
          // 3. Level card
          {
            ...
            popover: {
              title: 'Level Kamu',
              description: 'Naik level dengan rutin berlatih dan berpartisipasi pada fitur lainnya.',
              side: 'left',
              align: 'center',
            },
          },
          // 3b. Riwayat Latihan (History Section)
          {
            ...
            popover: {
              ...
              description: 'Lihat aktivitas dan progres latihan terakhirmu di sini.',
              side: 'left',
              align: 'center',
            },
          },
          // 4. Sidebar items (kecuali Dashboard)
          {
            ...
            popover: {
              title: 'Skor Swara',
              description: 'Masuk ke fitur analisis AI untuk menilai performa berbicara.',
              side: 'right',
              align: 'start',
            },
          },
          {
            ...
            popover: {
              title: 'Adu Swara',
              description: 'Bertanding dengan pengguna lain dalam kompetisi public speaking.',
              side: 'right',
              align: 'start',
            },
          },
          {
            ...
            popover: {
              title: 'Inspira Swara',
              description: 'Konten inspiratif, tips, dan teknik public speaking dari para ahli.',
              side: 'right',
              align: 'start',
            },
          },
          ...
          },
          {
            ...
            popover: {
              title: 'Latih Swara',
              description: 'Mulai latihan terstruktur untuk meningkatkan kemampuan berbicara.',
              side: 'right',
              align: 'start',
            },
          },
