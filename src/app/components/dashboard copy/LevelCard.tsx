...
export default function LevelCard({ level, xp, maxXp }: LevelCardProps) {
  ...
  return (
    <div
      className="bg-white rounded-3xl shadow-md p-4 sm:p-6 mb-4 sm:mb-5 hover:shadow-lg transition-shadow"
      data-tour="level-card"
    >
      ...
      <div className="flex items-center gap-3 mb-4 sm:mb-5 justify-center">
        <div className="text-orange-500 text-5xl sm:text-6xl lg:text-7xl font-bold leading-none">
          {level}
        </div>
      </div>
