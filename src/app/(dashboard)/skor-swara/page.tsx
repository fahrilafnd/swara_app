  ...
  const scoreCards: ScoreCard[] = [
    {
      ...
      icon: '🎯',
      description: 'Swara akan menilai kelancaran penyampaianmu, termasuk mendeteksi jeda yang terlalu lama. Pastikan setiap kata diucapkan dengan jelas.',
    },
    {
      title: 'Kontak Mata & Ekspresi',
      icon: '😄',
      description: 'Swara akan menganalisis kontak mata dan ekspresi wajah. Pertahankan kontak mata dan tunjukkan ekspresi yang percaya diri.',
    },
    {
      title: 'Penggunaan Bahasa',
      icon: '💬',
      description: 'Swara akan menganalisis pilihan kata, termasuk mendeteksi penggunaan kata pengisi yang tidak perlu (seperti "emmm") dan pengulangan kata.',
    },
  ];
