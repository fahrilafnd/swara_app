      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className="flex-1 overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden p-6 bg-white rounded-2xl">
          ...
          <div className="flex mb-4">
            <Link href={`/inspira/slug`} className="flex-1 flex flex-col justify-between relative h-[240px] mr-4 rounded-2xl overflow-hidden bg-[url('https://static.honestdocs.id/780x300/webp/system/blog_articles/images/000/008/579/original/mengatasi_suara_serak.jpg')] bg-cover bg-center">
              <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b to-[#434343] from-[#D9D9D910]"></div>
              <p className="bg-[#F07122] text-sm text-white w-max py-1 px-3 mr-3 mt-3 ms-auto rounded-lg z-10">18:42</p>
              ...
              <h4 className="font-semibold text-white ml-4 mb-5 z-10">Rahasia Public Speaking Tanpa Grogi</h4>
            </Link>
            <Link href={`/inspira/slug`} className="flex-1 flex flex-col justify-between relative h-[240px] rounded-2xl overflow-hidden bg-[url('https://static.honestdocs.id/780x300/webp/system/blog_articles/images/000/008/579/original/mengatasi_suara_serak.jpg')] bg-cover bg-center">
              <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b to-[#434343] from-[#D9D9D910]"></div>
              <p className="bg-[#F07122] text-sm text-white w-max py-1 px-3 mr-3 mt-3 ms-auto rounded-lg z-10">18:42</p>
              <div className="mx-auto cursor-pointer absolute top-0 bottom-0 right-0 left-0 m-auto w-max h-max">
                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link href={`/inspira/slug`} className="flex flex-col justify-between relative h-[240px] rounded-2xl overflow-hidden bg-[url('https://static.honestdocs.id/780x300/webp/system/blog_articles/images/000/008/579/original/mengatasi_suara_serak.jpg')] bg-cover bg-center">
              <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b to-[#434343] from-[#D9D9D910]"></div>
              <p className="bg-[#F07122] text-sm text-white w-max py-1 px-3 mr-3 mt-3 ms-auto rounded-lg z-10">18:42</p>
              <div className="mx-auto cursor-pointer absolute top-0 bottom-0 right-0 left-0 m-auto w-max h-max">
                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="bg-white rounded-2xl h-[38%] p-4 overflow-hidden">
            ...
            <div className="overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden h-full pb-14">
              <Link href={'/inspira/slug'} className="block mb-4">
                ...
                <h4 className="text-sm">Mengemas Cerita Menjadi Presentasi yang Kuat</h4>
              </Link>
              <Link href={'/inspira/slug'} className="block mb-4">
                <div className="w-full h-[170px] rounded-2xl text-[#39363D] mb-2 relative overflow-hidden bg-[url('https://static.honestdocs.id/780x300/webp/system/blog_articles/images/000/008/579/original/mengatasi_suara_serak.jpg')] bg-cover bg-center">
                  <div className="mx-auto cursor-pointer absolute top-0 bottom-0 right-0 left-0 m-auto w-max h-max">
            ...
            <div className="h-full relative overflow-hidden pb-[86px]">
              <div className="h-full overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                <div className="flex items-end mb-4">
                  ...
                  <p className="text-sm font-light bg-[#B3C8CF] py-2 px-2 rounded-xl rounded-bl-none">Apakah kamu gugup, grogi, atau merasa kurang percaya diri ketika berbicara?</p>
                </div>
                <div className="flex items-end mb-4">
                  <p className="text-sm font-light bg-[#F07122] text-white py-2 px-2 rounded-xl rounded-br-none">Saya kesulitan mencari video menarik public speaking</p>
                  <img src="https://i.pinimg.com/736x/5b/03/a2/5b03a2f8bd8d357c97754d572a3b816b.jpg" alt="" className="ml-2 w-8 h-8 rounded-full" />
                </div>
                <div className="flex items-end mb-4">
                  <p className="text-sm font-light bg-[#F07122] text-white py-2 px-2 rounded-xl rounded-br-none">Saya kesulitan mencari video menarik public speaking</p>
                  <img src="https://i.pinimg.com/736x/5b/03/a2/5b03a2f8bd8d357c97754d572a3b816b.jpg" alt="" className="ml-2 w-8 h-8 rounded-full" />
              ...
              <div className="w-full flex px-1 pt-2">
                <input type="text" name="" id="" className="w-full text-sm border border-[#B3C8CF70] focus:outline-2 focus:outline focus:outline-[#F07122] rounded-2xl py-3 pl-4 pr-14" placeholder="Ceritakan keluh kesahmu" />
                <button className="-translate-x-10 -mr-10">
                  <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="28" height="28" rx="14" fill="#F07122"/>
                    <path d="M10.0445 19.9399C9.79579 20.0376 9.55954 20.0161 9.33572 19.8755C9.11191 19.7348 9 19.5304 9 19.2622V15.9652L14.9684 14.4998L9 13.0345V9.73743C9 9.46878 9.11191 9.26436 9.33572 9.12418C9.55954 8.98399 9.79579 8.9625 10.0445 9.0597L21.5337 13.8221C21.8446 13.9564 22 14.1823 22 14.4998C22 14.8173 21.8446 15.0432 21.5337 15.1775L10.0445 19.9399Z" fill="white"/>
                  </svg>
                </button>
              </div>
            </div>
