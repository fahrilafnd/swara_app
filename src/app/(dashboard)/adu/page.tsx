            ...
            <div className="flex flex-1 overflow-hidden">
                <aside className="flex-1 overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                    <div className="bg-white rounded-2xl mb-6 p-10 flex items-center">
                        <div>
                            <img src="https://i.pinimg.com/736x/5b/03/a2/5b03a2f8bd8d357c97754d572a3b816b.jpg" alt="profile" className="w-[280px] rounded-full mb-6"/>
                            <h2 className="text-center text-[#39363D] text-3xl font-semibold">Kimberly</h2>
                        </div>
                        <div className="flex-1 ml-12">
                            <div className="flex items-center mb-6">
                                <p className="font-bold text-2xl border border-[#30303040] w-max py-3 px-3 rounded-3xl mr-5">🥇</p>
                                <p className="text-[#39363D] py-3 px-8 border border-[#30303040] rounded-3xl text-lg font-medium w-full flex justify-between">Win rate &nbsp;&nbsp;: <span>53%</span></p>
                            </div>
                            <div className="flex items-center mb-6">
                                <p className="font-bold text-2xl border border-[#30303040] w-max py-3 px-3 rounded-3xl mr-5">💯</p>
                                <p className="text-[#39363D] py-3 px-8 border border-[#30303040] rounded-3xl text-lg font-medium w-full flex justify-between">Latest Score &nbsp;&nbsp;: <span>320</span></p>
                            </div>
                            <div className="flex items-center mb-6">
                                <p className="font-bold text-2xl border border-[#30303040] w-max py-3 px-3 rounded-3xl mr-5">🥇</p>
                                <p className="text-[#39363D] py-3 px-8 border border-[#30303040] rounded-3xl text-lg font-medium w-full flex justify-between">Weekly Rank &nbsp;&nbsp;: <span>44th</span></p>
                            </div>
                            <div className="flex items-center mb-6">
                                <p className="font-bold text-2xl border border-[#30303040] w-max py-3 px-3 rounded-3xl mr-5">📊</p>
                                <p className="text-[#39363D] py-3 px-8 border border-[#30303040] rounded-3xl text-lg font-medium w-full flex justify-between">Average Score &nbsp;&nbsp;: <span>280</span></p>
                            </div>
                        </div>
                    </div>
                    <div className="bg-white grid grid-cols-2 rounded-2xl p-7 gap-6 mb-7">
                        <div className="bg-[#F0712220] border border-[#F07122] rounded-2xl p-6">
                            ...
                            <p className="text-sm text-[#39363D]">Swara akan menilai kelancaran penyampaianmu, termasuk mendeteksi jeda yang terlalu lama. Pastikan setiap kata diucapkan dengan jelas.</p>
                        </div>
                        <div className="bg-[#F0712220] border border-[#F07122] rounded-2xl p-6">
                            <span className="flex items-center mb-4">
                                <p className="text-2xl bg-[#F0712220] p-2 rounded-xl">📝</p>
                    ...
                    <button onClick={() => setIsOpenMatch(true)} className="bg-[#F07122] text-white text-2xl py-4 w-full rounded-2xl font-bold mb-7"> ⚔️ Mulai Battle ⚔️ </button>
                    <div className="bg-white rounded-2xl p-7">
                        ...
                        <div className="flex space-x-5 overflow-x-auto scrollbar-custom pb-2">
                            <div className="flex-shrink-0 bg-white rounded-2xl border border-[#B3C8CF] shadow-md text-center py-5 px-4">
                                <img src="https://i.pinimg.com/736x/5b/03/a2/5b03a2f8bd8d357c97754d572a3b816b.jpg" className="w-[130px] h-[130px] rounded-full mb-2" alt="" />
                                <p className="font-bold text-[#39363D] mb-3">Tokoyaki22</p>
                                <span className="block w-full bg-[#509F7F] text-white text-sm rounded-full py-2 font-semibold mb-2">MENANG!</span>
                                <span className="block w-full bg-[#7EC492] text-white text-sm rounded-full py-2 font-semibold">25</span>
                            </div>
                            <div className="flex-shrink-0 bg-white rounded-2xl border border-[#B3C8CF] shadow-md text-center py-5 px-4">
                                <img src="https://i.pinimg.com/736x/5b/03/a2/5b03a2f8bd8d357c97754d572a3b816b.jpg" className="w-[130px] h-[130px] rounded-full mb-2" alt="" />
                                <p className="font-bold text-[#39363D] mb-3">Tokoyaki22</p>
                ...
                <aside className="w-96 sticky top-0 h-full ml-4 flex flex-col justify-between">
                    <div className="bg-white rounded-2xl h-full overflow-hidden">
                        ...
                        <div className="overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden h-full pb-14 p-4">
                            <Link href={`/inspira/slug`} className="flex flex-col justify-end relative h-[185px] rounded-2xl overflow-hidden mb-5 bg-[url('https://static.honestdocs.id/780x300/webp/system/blog_articles/images/000/008/579/original/mengatasi_suara_serak.jpg')] bg-cover bg-center">
                                ...
                                <div className="mx-auto cursor-pointer absolute top-0 bottom-0 right-0 left-0 m-auto w-max h-max">
                                    ...
                                    <path d="M26.2664 20.516C26.4979 20.3369 26.6853 20.1071 26.8142 19.8443C26.9431 19.5815 27.0101 19.2927 27.0101 19C27.0101 18.7073 26.9431 18.4185 26.8142 18.1557C26.6853 17.8929 26.4979 17.6631 26.2664 17.484C23.2686 15.1652 19.9216 13.3371 16.3504 12.068L15.6974 11.836C14.4494 11.393 13.1304 12.237 12.9614 13.526C12.4894 17.1601 12.4894 20.8399 12.9614 24.474C13.1314 25.763 14.4494 26.607 15.6974 26.164L16.3504 25.932C19.9216 24.6629 23.2686 22.8348 26.2664 20.516Z" fill="#F07122"/>
                                    </svg>
                                </div>
                                <h4 className="font-semibold text-white ml-4 mb-5 z-10 text-sm">Rahasia Public Speaking Tanpa Grogi</h4>
                            </Link>
                            <Link href={`/inspira/slug`} className="flex flex-col justify-end relative h-[185px] rounded-2xl overflow-hidden mb-5 bg-[url('https://static.honestdocs.id/780x300/webp/system/blog_articles/images/000/008/579/original/mengatasi_suara_serak.jpg')] bg-cover bg-center">
                                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b to-[#434343] from-[#D9D9D910]"></div>
                                <div className="mx-auto cursor-pointer absolute top-0 bottom-0 right-0 left-0 m-auto w-max h-max">
            ...
            {isOpenMatch && (
                <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
                    <div className="bg-white rounded-2xl p-6 shadow-lg w-[600px]">
                        ...
                        <p className="border border-[#B3C8CF] shadow-md mb-4 p-3 rounded-2xl text-[#F07122] text-sm">Merancang Masa Depan: Membangun Karier di Era Digital</p>
                        ...
                        <p className="text-center text-[#F07122] text-lg font-semibold">detik</p>
                        <button className="bg-[#F07122] w-[80%] py-3 text-white font-semibold rounded-full mt-6 mx-auto block">Sudah Siap!</button>
                    </div>
                </div>
            )}
        </div>
