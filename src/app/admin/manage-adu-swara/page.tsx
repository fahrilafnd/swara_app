                                                    ...
                                                    <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                                                        <td className="px-6 py-4">
                                                            <div className="flex items-center">
                                                                <div className="flex items-center">
                                                                    <img src="https://i.pinimg.com/736x/5b/03/a2/5b03a2f8bd8d357c97754d572a3b816b.jpg" className="w-[38px] h-[38px] rounded-full mr-2" alt="pp1" />
                                                                    <p className="text-sm">Siti Nurhaliza</p>
                                                                </div>
                                                                <p className="text-[#F07122] text-sm font-bold mx-4">VS</p>
                                                                <div className="flex items-center">
                                                                    <img src="https://i.pinimg.com/736x/5b/03/a2/5b03a2f8bd8d357c97754d572a3b816b.jpg" className="w-[38px] h-[38px] rounded-full mr-2" alt="pp1" />
                                                                    <p className="text-sm">Siti Nurhaliza</p>
                                                                </div>
                                                        ...
                                                        <td className="px-6 py-4">
                                                            <p className="text-[#39363D] text-sm">{item.topik}</p>
                                                        </td>
                                                        <td className="px-6 py-4">
                                                            <p className="w-max text-white text-sm bg-gradient-to-l to-[#F07122] from-[#F8C56A] py-2 px-3 rounded-lg">🏆 {item.pemenang}</p>
                                                        </td>
                                                        <td className="px-6 py-4">
                                                            <p className="text-[#39363D] text-sm">{item.bergabung}</p>
                                                        </td>
                                                        <td className="px-6 py-4">
                                                            <div className="flex items-center gap-2">
                                                                <Link 
                        ...
                        {activeTab === 'topics' && (
                            <div>
                                <div className="flex items-center justify-between mb-8">
                                    ...
                                    <button className="bg-[#F07122] text-white py-3 px-4 text-sm rounded-md flex items-center" onClick={() => handleAdd()}><Plus className="w-4 h-4 mr-3" />Tambah Topik Baru</button>
                                </div>
                                <div className="bg-white rounded-2xl shadow-md overflow-hidden">
                                    <div className="overflow-x-auto">
                                        <table className="w-full">
                                            ...
                                            <tbody className="bg-white divide-y divide-gray-200">
                                                {sortedDataTopik.map((item) => (
                                                    <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                                                        <td className="px-6 py-4">
                                                            <p className="text-sm">{item.topik}</p>
                                                        </td>
                                                        <td className="px-6 py-4">
                                                            <p className="text-[#3C40AF] text-xs bg-[#DBEAFE] w-max py-2 px-4 rounded-full">{item.kategori}</p>
                                                        </td>
                                                        <td className="px-6 py-4">
                                                            <p className="text-sm">{item.digunakan}</p>
                                                        </td>
                                                        <td className="px-6 py-4">
                                                            <p className="text-[#39363D] text-sm">{item.dibuat}</p>
                                                        </td>
                                                        <td className="px-6 py-4">
                                                            <div className="flex items-center gap-2">
                                                                <button
                                                                    ...
                                                                    className="p-2 hover:bg-orange-300 rounded-lg transition-colors"
                                                                >
                                                                    <Edit className="w-5 h-5 text-[#F07122]" />
                                                                </button>
                                                                <button
                                                                    onClick={() => handleDeleteClick(item)}
                                                                    className="p-2 hover:bg-orange-300 rounded-lg transition-colors"
                                                                >
                                                                    <Trash2 className="w-5 h-5 text-[#F07122]" />
                                                                </button>
                                                            </div>
                                                        </td>
                                                    </tr>
