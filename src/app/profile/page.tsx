...
import { User, MapPin, Calendar, Star, Award, Target, Flame, Bell, ChevronRight, LogOut, Settings, X, Plus } from 'lucide-react';
      ...
      <div className="flex flex-col flex-1 md:ml-60">
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-3">Minat dan Preferensi</label>
        ...
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-6 text-white mb-8 shadow-lg">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="font-bold text-lg mb-2">Orator Pemula - Level 2</h3>
              <p className="text-indigo-100">Kamu sudah mulai menguasai dasar-dasar public speaking! Teruskan latihan untuk mencapai level berikutnya.</p>
              <p className="text-sm mt-2 text-indigo-200">➡️ Level selanjutnya: Pembicara Percaya Diri (Level 3) - Butuh 350 XP lagi!</p>
            </div>
          </div>
        </div>
          ...
          <div className="p-8">
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <span className="bg-orange-500 text-white px-4 py-1 rounded-full text-sm font-semibold">Level {userData.level}</span>
                    <span className="text-orange-600 font-bold">{userData.xp}/{userData.maxXp} XP</span>
                  </div>
                  <div className="flex items-center gap-4 text-gray-600 text-sm">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span>Total Poin: {userData.totalPoints.toLocaleString()}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-4 gap-4">
              <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl border-2 border-orange-200">
                <div className="text-4xl font-bold text-orange-600 mb-2">{userData.stats.completedTraining}</div>
              ...
              <div className="text-center p-6 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors">
                <div className="text-4xl font-bold text-gray-700 mb-2">{userData.stats.minutesPracticed}</div>
                <div className="text-sm text-gray-600">Menit berlatih</div>
              </div>
              <div className="text-center p-6 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors">
                <div className="text-4xl font-bold text-gray-700 mb-2">{userData.stats.successRate}%</div>
                <div className="text-sm text-gray-600">Tingkat keberhasilan</div>
              </div>
              <div className="text-center p-6 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors">
                <div className="text-4xl font-bold text-gray-700 mb-2">{userData.stats.badgesEarned}</div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800">Pencapaian & Badge</h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {userData.badges.map((badge) => (
              ...
              >
                ...
                {!badge.unlocked && (
                  <div className="mt-2 text-xs text-gray-500 italic">Belum terbuka</div>
                )}
              </div>
            ))}
          </div>
